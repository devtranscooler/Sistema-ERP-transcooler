    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1">
                ...
                <li class="breadcrumb-item active">
                    <i class="bi bi-truck me-1"></i>Destinos
                </li>
            </ol>
        </nav>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                ...
                <button class="btn btn-primary  shadow-sm" onclick="abrirModal('formDestinos.php')">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <label for="filtroNombre" class="form-label small text-muted">
                        <i class="bi bi-truck-front"></i> Buscar por Nombre
                    </label>
        ...
        <div class="table-responsive mb-0">
            <table class="table table-hover aligmiddle mb-0" id="tablaDestinos">
                <thead>
                    <tr>
