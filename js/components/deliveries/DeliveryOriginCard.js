export function DeliveryOriginCard(delivery) {
        ...
        <div class="col-12 col-md-6 col-xl-4">
            ...
            <div class="bg-white rounded-4 p-3 p-md-4 border shadow-sm h-100 d-flex flex-column">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-light rounded-circle border d-flex justify-content-center align-items-center flex-shrink-0"
                            ...
                            <i class="bi bi-flag fs-5 text-dark"></i>
                        </div>
                        <div>
                            <h5 class="mb-0 fw-semibold">Origen</h5>
                            <small class="text-secondary">Punto de inicio</small>
                        </div>
                    </div>
                ...
                <div class="mt-4 pb-3 border-bottom flex-grow-1">
                    <p class="mb-0 text-secondary lh-sm text-break"> 
                        Dirección: ${delivery.origen_inicio ?? 'S/D'} 
                    </p>
                </div>
